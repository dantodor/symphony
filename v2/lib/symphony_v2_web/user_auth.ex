defmodule SymphonyV2Web.UserAuth do
  @moduledoc """
  Plugs and helpers for user authentication.
  """
  ...
  @remember_me_cookie "_symphony_v2_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      SymphonyV2Web.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
