defmodule SymphonyV2.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "validates email when given" do
      {:error, changeset} =
        Accounts.register_user(%{email: "not valid", password: valid_user_password()})
    ...
    test "validates maximum values for email for security" do
      ...
      {:error, changeset} =
        Accounts.register_user(%{email: too_long, password: valid_user_password()})
